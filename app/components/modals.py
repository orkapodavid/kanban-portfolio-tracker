    ...
    return rx.dialog.root(
        rx.dialog.content(
            ...
            rx.el.div(
                ...
                rx.el.label(
                    "Effective Date/Time (Optional Override)",
                    class_name="text-sm font-medium text-gray-700 block mb-2",
                ),
                rx.el.input(
                    type="datetime-local",
                    on_change=KanbanState.set_custom_transition_date,
                    class_name="w-full rounded-md border border-gray-300 p-2 text-sm mb-4 focus:border-blue-500 focus:ring-1 focus:ring-blue-500",
                    default_value=KanbanState.custom_transition_date,
                ),
                rx.el.label(
                    "Transition Comment",
                    class_name="text-sm font-medium text-gray-700 block mb-2",
        ...
        rx.dialog.content(
            ...
            rx.el.div(
                ...
                rx.el.select(
                    ...
                    value=KanbanState.modal_user,
                    on_change=KanbanState.set_modal_user,
                    class_name="w-full rounded-md border border-gray-300 p-2 text-sm mb-4 focus:border-amber-500 focus:ring-1 focus:ring-amber-500",
                ),
                rx.el.label(
                    "Effective Date/Time (Optional Override)",
                    class_name="text-sm font-medium text-gray-700 block mb-2",
